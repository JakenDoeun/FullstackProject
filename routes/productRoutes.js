...
router.get('/house_sell', productController.getAllProducts_buy); // Get all products for buying
...
router.get('/detial/:id', productController.getProductById); // Show product details
